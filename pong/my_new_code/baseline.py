...
def train(args):
    ...
    # datetime_obj_start = datetime.fromtimestamp(start_time)
    ...
    for batch_cnt in tqdm(range(num_batches), desc="Training Batch"):
        ...
        for epoch in range(args.update_epochs):
            ...
            for begin in range(0, args.batch_size, args.minibatch_size):
                ...
                # Policy loss
                pg_loss1 = -minibatch_advantages * importance_sampling_ratio
                ...
                # total loss
                loss = pg_loss + value_loss * args.vf_coef - args.ent_coef * entropy_loss
